...
public class TransactionWorkflow extends LaunchApplication {
	...
	/* METHOD TO SELECT LINK BY PASSING WORKFOW NAME AND THE RESPECTIVE DOCUMENT NUMBER AS PARAMETERS */
  public void workflow(String workflowname, String vouchernum) throws InterruptedException 
  {
	  ...
	  try
	  {
		  /* EXPAND WORKFLOW AND THEN SELECT THE WORKFLOW WHICH IS SENT FROM EXCEL */
		...
		/* GET THE COLUMN NO OF THE VOUCHER NO */
		 ...
		 /* GO TO EACH ROW OF THE VOUCHERNO COLUMN AND SELECT THAT PARTICULAR VOUCHER WHCIH MATCHES WITH THE ONE WHICH IS SENT FROM EXCEL */
